package skyglass.composer.order.endtoendtests;
...
import skyglass.composer.order.customers.webapi.GetCustomerHistoryResponse;
...
import skyglass.composer.util.test.async.Eventually;
...
public class CustomersAndOrdersE2ETest {
	...
	public void shouldSupportOrderHistory() {
		...
		Eventually.eventually(() -> {
			ResponseEntity<GetCustomerHistoryResponse> customerResponseEntity = restTemplate.getForEntity(baseUrl("customers", Long.toString(createCustomerResponse.getCustomerId()), "orderhistory"),
