...
import skyglass.composer.messaging.kafka.common.sbe.MessageHeaderDecoder;
import skyglass.composer.messaging.kafka.common.sbe.MessageHeaderEncoder;
import skyglass.composer.messaging.kafka.common.sbe.MultiMessageDecoder;
	...
	public static class MessageBuilder {
		...
		public byte[] toBinaryArray() {
			...
			messagesToWrite.forEach(message -> {
				...
				MultiMessageEncoder.MessagesEncoder.HeadersEncoder messageHeadersEncoder = messagesEncoder.headersCount(message.getHeaders().size());
