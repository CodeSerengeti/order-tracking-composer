...
public class StepBuilder<Data> implements WithCompensationBuilder<Data> {
	...
	public <C extends Command> InvokeParticipantStepBuilder<Data> invokeParticipant(Predicate<Data> participantInvocationPredicate, CommandEndpoint<C> commandEndpoint,
			Function<Data, C> commandProvider) {
