package skyglass.composer.common.json.mapper;
...
import skyglass.composer.common.id.Int128;

public class Int128Module extends SimpleModule {

	private static final long serialVersionUID = 772387560995525983L;

	class IdDeserializer extends StdScalarDeserializer<Int128> {

		private static final long serialVersionUID = -6082834417619474361L;
	...
	class IdSerializer extends StdScalarSerializer<Int128> {
		...
		private static final long serialVersionUID = -8704322301043503920L;
